...
class File3dm:
    ...
    @property
    def InstanceDefinitions(self) -> File3dmInstanceDefinitionTable: ...
    @property
...
class File3dmInstanceDefinitionTable:
    def Add(self, idef: InstanceDefinition) -> int: ...
...
class InstanceDefinition(CommonObject):
    ...
    @property
    def GetObjectIds(self) -> List[Guid]: ...
    def SetObjectIds(sel, ids: List[Guid]) -> None : ...
    def SetLinkedFileReference(self, type: InstanceDefinitionUpdateType, file: FileReference) -> bool: ...
    def IsInstanceGeometryId(self) -> List[Guid]: ...
...
class InstanceReference(CommonObject): ...    
    @property
