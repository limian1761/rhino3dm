...
public:
  ...
  bool SetLinkedFileReference(InstanceDefinitionUpdateType linked_definition_type, BND_FileReference linked_file_reference);
  void SetObjectIds(ON_SimpleArray<ON_UUID>& list);
